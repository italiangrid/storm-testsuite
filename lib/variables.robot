...
${VOMS_FAKE_FQANS.2}   /test.vo.2/Role=NULL/Capability=NULL,/test.vo.2/G1/Role=NULL/Capability=NULL,/test.vo.2/G2/Role=NULL/Capability=NULL,/test.vo.2/G2/G3/Role=NULL/Capability=NULL
#${VOMS_FAKE_FQANS}   /test.vo,/test.vo/G1,/test.vo/G2,/test.vo/G2/G3
