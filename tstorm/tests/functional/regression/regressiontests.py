...
def ts_storm_backend_age(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_storm_backend_age'][5])
    lfn.put_description(uid['ts_storm_backend_age'][6])
...
def ts_storm_database_password(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_storm_database_password'][5])
    lfn.put_description(uid['ts_storm_database_password'][6])
...
def ts_storm_gridhttps_authorization_denied(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_storm_gridhttps_authorization_denied'][5])
    lfn.put_description(uid['ts_storm_gridhttps_authorization_denied'][6])
