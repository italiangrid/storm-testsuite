...
def ts_cksm(conf, ifn, dfn, bifn, uid, lfn):
    ...
    s.addTest(utilities.UtilitiesTest('test_dd',conf, ifn, dfn, bifn, lfn))
    s.addTest(fu.FunctionalitiesTest('test_cksm',conf, ifn, dfn, bifn, lfn)) 
    s.addTest(utilities.UtilitiesTest('test_rm_lf',conf, ifn, dfn, bifn, lfn))
...
def ts_https_voms(conf, ifn, dfn, bifn, uid, lfn):
    ...
    s.addTest(utilities.UtilitiesTest('test_cr_lf',conf, ifn, dfn, bifn, lfn))
