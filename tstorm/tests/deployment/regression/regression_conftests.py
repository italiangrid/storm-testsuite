...
def ts_backend_server_status(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_backend_server_status'][3])
    lfn.flush_file()
...
def ts_backend_logrotate_file(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_backend_logrotate_file'][3])
    lfn.flush_file()
...
def ts_backend_cron_file(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_backend_cron_file'][3])
    lfn.flush_file()
...
def ts_backend_gridhttps(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_backend_gridhttps'][3])
    lfn.flush_file()
...
def ts_yaim_version_file(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_yaim_version_file'][3])
    lfn.flush_file()
...
def ts_gridhttps_plugin_links(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_gridhttps_plugin_links'][3])
    lfn.flush_file()
...
def ts_size_in_namespace_file(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_size_in_namespace_file'][3])
    lfn.flush_file()
...
def ts_mysql_connector_java_links(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_mysql_connector_java_links'][3])
    lfn.flush_file()
...
def ts_backend_server_name_status(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_backend_server_name_status'][3])
    lfn.flush_file()
...
def ts_mysql_storage_space_update(conf, uid, lfn):
    ...
    lfn.put_ruid(self.uid['ts_mysql_storage_space_update'][3])
    lfn.flush_file()
