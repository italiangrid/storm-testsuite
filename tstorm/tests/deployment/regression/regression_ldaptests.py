...
def ts_glue_service(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_glue_service'][5])
    lfn.put_description(uid['ts_glue_service'][6])
...
def ts_glue_available_space_info_service(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_glue_available_space_info_service'][5])
    lfn.put_description(uid['ts_glue_available_space_info_service'][6])
...
def ts_glue_available_space(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_glue_available_space'][5])
    lfn.put_description(uid['ts_glue_available_space'][6])
...
def ts_glue_used_space(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_glue_used_space'][5])
    lfn.put_description(uid['ts_glue_used_space'][6])
...
def ts_size(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_size'][5])
    lfn.put_description(uid['ts_size'][6])
...
def ts_info_service_failure(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_info_service_failure'][5])
    lfn.put_description(uid['ts_info_service_failure'][6])
...
def ts_gluetwo_endpoint_undefined(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_gluetwo_endpoint_undefined'][5])
    lfn.put_description(uid['ts_gluetwo_endpoint_undefined'][6])
...
def ts_gluetwo_storage_share_capacity(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_gluetwo_storage_share_capacity'][5])
    lfn.put_description(uid['ts_gluetwo_storage_share_capacity'][6])
...
def ts_gluetwo_storage_undefined(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_gluetwo_storage_undefined'][5])
    lfn.put_description(uid['ts_gluetwo_storage_undefined'][6])
...
def ts_gluetwo_endpoint(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_gluetwo_endpoint'][5])
    lfn.put_description(uid['ts_gluetwo_endpoint'][6])
...
def ts_gluetwo_service(conf, uid, lfn):
    ...
    lfn.put_name(uid['ts_gluetwo_service'][5])
    lfn.put_description(uid['ts_gluetwo_service'][6])
