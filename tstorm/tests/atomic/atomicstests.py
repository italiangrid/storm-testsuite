...
def ts_storm_ping(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_storm_ping'][5])
    lfn.put_description(uid['ts_storm_ping'][6])
...
def ts_storm_ping_wo(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_storm_ping_wo'][5])
    lfn.put_description(uid['ts_storm_ping_wo'][6])
...
def ts_storm_gtp(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_storm_gtp'][5])
    lfn.put_description(uid['ts_storm_gtp'][6])
...
def ts_storm_gtp_wo(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_storm_gtp_wo'][5])
    lfn.put_description(uid['ts_storm_gtp_wo'][6])
...
def ts_lcg_ls_unexist_file(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_lcg_ls_unexist_file'][5])
    lfn.put_description(uid['ts_lcg_ls_unexist_file'][6])
...
def ts_dcache_mkdir(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_dcache_mkdir'][5])
    lfn.put_description(uid['ts_dcache_mkdir'][6])
...
def ts_dcache_mkdir_exist(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_dcache_mkdir_exist'][5])
    lfn.put_description(uid['ts_dcache_mkdir_exist'][6])
...
def ts_lcg_ls_dir(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_lcg_ls_dir'][5])
    lfn.put_description(uid['ts_lcg_ls_dir'][6])
...
def ts_lcg_cp_out(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_lcg_cp_out'][5])
    lfn.put_description(uid['ts_lcg_cp_out'][6])
...
def ts_lcg_ls_file(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_lcg_ls_file'][5])
    lfn.put_description(uid['ts_lcg_ls_file'][6])
...
def ts_dcache_rm_file(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_dcache_rm_file'][5])
    lfn.put_description(uid['ts_dcache_rm_file'][6])
...
def ts_dcache_rm_unexist_file(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_dcache_rm_unexist_file'][5])
    lfn.put_description(uid['ts_dcache_rm_unexist_file'][6])
...
def ts_dcache_rm_unexist_dir(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_dcache_rm_unexist_dir'][5])
    lfn.put_description(uid['ts_dcache_rm_unexist_dir'][6])
...
def ts_lcg_cp_in(conf, ifn, dfn, bifn, uid, lfn):
    ...
    lfn.put_name(uid['ts_lcg_cp_in'][5])
    lfn.put_description(uid['ts_lcg_cp_in'][6])
