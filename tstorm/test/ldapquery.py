...
class LdapTest(unittest.TestCase):
    ...
    def test_glue_service(self):
      print '''\nName          : STORM BUG: GLUESERVICENAME AND GLUESERVIVETYPE CONTAIN WRONG VALUES'''
...
and GlueServiceType attributes of the GLUE1.3 schema.'''
    ...
    def test_glue_storage_share_capacity(self):
      print '''\nName          : GLUE2 GLUE2STORAGESHARECAPACITY* SIZES ALWAYS ZERO'''
    ...
    def test_glue_available_space(self):
      print '''\nName          : WRONG CALCULATION OF SA_AVAILABLE_SIZE_KB AND SA_USED_SIZE_KB'''
    ...
    def test_size(self):
      print '''\nName          : GET_SIZE INCORRECTLY HANDLES THE INFO'''
      print '''Description   : Wrong calculation of SA_USED_SPACE'''
