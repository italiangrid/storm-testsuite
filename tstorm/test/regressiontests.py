...
def update_free_space_upon_rm_ts(conf, ifn, dfn, bifn):
...
def eight_digit_string_checksum_ts(conf, ifn, dfn, bifn):
  s = unittest.TestSuite()
  s.addTest(ut.UtilitiesTest('test_dd',conf, ifn, dfn, bifn))
...
def update_used_space_upon_pd_ts(conf, ifn, dfn, bifn):
  s = unittest.TestSuite()
  s.addTest(ut.UtilitiesTest('test_dd',conf, ifn, dfn, bifn))
...
def unsupported_protocols_ts(conf, ifn, dfn, bifn):
  s = unittest.TestSuite()
  s.addTest(ut.UtilitiesTest('test_dd',conf, ifn, dfn, bifn))
