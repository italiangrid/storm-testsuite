...
class AtomicsTest(unittest.TestCase):
    ...
    def test_ls_unexist_dir(self):
      ...
      if '/' in self.dfn:
        ...
        lcg_ls = ls.LcgLs(self.tsets['general']['endpoint'], self.tsets['general']['accesspoint'], a)
        self.lfn.put_cmd(lcg_ls.get_command())
        self.ls_result = lcg_ls.get_output()
        self.assert_(self.ls_result['status'] == 'FAILURE')
    ...
    def test_mkdir_dir(self):
      ...
      if '/' in self.dfn:
        a=os.path.dirname(self.dfn)
        srm_mkdir = mkdir.SrmMkdir(self.tsets['general']['endpoint'], self.tsets['general']['accesspoint'], a)
    ...
    def test_rm_dir(self):
      ...
      if '/' in self.dfn:
        a=os.path.dirname(self.dfn)
        srm_rmdir_result = rmdir.SrmRmdir(self.tsets['general']['endpoint'], self.tsets['general']['accesspoint'], a)
