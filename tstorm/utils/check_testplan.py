...
class CheckTestplan:
    def __init__(self):
        ...
        self.methods = {
            ...
            'ping_wo_ts': 'bt.ping_wo_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'gtp_ts': 'bt.gtp_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'gtp_wo_ts': 'bt.gtp_wo_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'ls_unexist_file_ts': 'bt.ls_unexist_file_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'mkdir_ts': 'bt.mkdir_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'mkdir_exist_ts': 'bt.mkdir_exist_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'ls_dir_ts': 'bt.ls_dir_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'cp_out_ts': 'bt.cp_out_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'ls_file_ts': 'bt.ls_file_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'rm_file_ts': 'bt.rm_file_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'rm_unexist_dir_ts': 'bt.rm_unexist_dir_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
            'cp_in_ts': 'bt.cp_in_ts(tfn,ifn,dfn,back_ifn, uid, lfn)',
