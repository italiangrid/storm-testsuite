...
Perform ptp using clientSRM  [Arguments]  ${surl}  ${options}=${EMPTY}
  ${output}  ${token}  Perform ptp with transfer protocol using clientSRM  ${surl}  https  ${options}
  RETURN  ${output}  ${token}
...
Perform synch ptp using clientSRM  [Arguments]  ${surl}  ${options}=${EMPTY}
  ${output}  ${token}  Perform ptp with transfer protocol using clientSRM  ${surl}  https  ${options} -p
...
Perform ptg using clientSRM  [Arguments]  ${surl}  ${options}=${EMPTY}
  ${output}  ${token}  Perform ptg with transfer protocol using clientSRM  ${surl}  https  ${options}
  RETURN  ${output}  ${token}

Perform synch ptg using clientSRM  [Arguments]  ${surl}  ${options}=${EMPTY}
  ${output}  ${token}  Perform ptg with transfer protocol using clientSRM  ${surl}  https  ${options} -p
...
Put without really putting using clientSRM  [Arguments]  ${surl}
  ${output}  ${token}  ${turl}  Perform synch ptp using clientSRM  ${surl}
